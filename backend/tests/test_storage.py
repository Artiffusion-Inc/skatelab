...
class TestPresignedURL:
    ...
    def test_get_object_url_default_method(self):
        ...
        with patch("app.storage.get_s3_client") as mock_get_client:
            ...
            mock_get_client.return_value.generate_presigned_url.assert_called_once()
            call_args = mock_get_client.return_value.generate_presigned_url.call_args
...
class TestAsyncObjectOperations:
    ...
    @pytest.mark.asyncio
    async def test_object_exists_async_false(self):
        from botocore.exceptions import ClientError
    ...
    @pytest.mark.asyncio
    async def test_stream_object_async(self):
        mock_body = MagicMock()
    ...
    @pytest.mark.asyncio
    async def test_list_objects_async(self):
        mock_s3 = MagicMock()
