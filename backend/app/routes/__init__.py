...
gamification = Router(path="/gamification", route_handlers=[GamificationController])
...
phases = Router(path="/phases", route_handlers=[PhasesController])
process = Router(path="/process", route_handlers=[ProcessController])
scores = Router(path="/scores", route_handlers=[ScoresController])
