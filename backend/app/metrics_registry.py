...
METRIC_REGISTRY: dict[str, MetricDef] = {
    ...
    "rotation_symmetry": MetricDef(
        name="rotation_symmetry",
        label_ru="Симметрия вращения",
        unit="ratio",
        format=".2f",
        direction="higher",
        element_types=JUMP_ELEMENTS,
        ideal_range=(0.75, 1.0),
    ),
    "imu_peak_delta": MetricDef(
        name="imu_peak_delta",
        label_ru="Расхождение пиков IMU",
        unit="ms",
        format=".0f",
        direction="lower",
        element_types=JUMP_ELEMENTS,
        ideal_range=(0.0, 80.0),
    ),
    "landing_stability": MetricDef(
        name="landing_stability",
        label_ru="Стабильность после приземления",
        unit="ratio",
        format=".2f",
        direction="higher",
        element_types=JUMP_ELEMENTS,
    ...
    "imu_offset_error": MetricDef(
        name="imu_offset_error",
        label_ru="Ошибка синхронизации IMU",
        unit="ms",
        format=".0f",
        direction="lower",
        element_types=JUMP_ELEMENTS,
        ideal_range=(0.0, 40.0),
    ),
    "imu_rate_error": MetricDef(
        name="imu_rate_error",
        label_ru="Ошибка частоты IMU",
        unit="Hz",
        format=".1f",
        direction="lower",
        element_types=JUMP_ELEMENTS,
