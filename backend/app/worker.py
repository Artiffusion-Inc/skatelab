    ...
    *,
    ...
    try:
        ...
        response_data = {
            ...
            "segments": vast_result.segments,
            "rotations": vast_result.rotations,
            "schema_version": vast_result.schema_version,
            "processed_frames": vast_result.processed_frames,
            "valid_frames": vast_result.valid_frames,
            "timings": vast_result.timings,
            "stages": vast_result.stages,
            "warnings": vast_result.warnings,
            "annotations": vast_result.annotations,
            "analysis": vast_result.analysis,
