...
install_dokploy() {
    ...
    # DISABLED: 80/443 checks removed — Caddy keeps them; Dokploy Traefik on 8080/8443.
    ...
    docker service create \
      ...
      --publish published=18080,target=3000,mode=host \
    ...
    printf "${YELLOW}Please go to http://${formatted_addr}:18080${NC}\n\n"
}
