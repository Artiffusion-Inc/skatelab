...
extension Color {
    ...
    static let skatePrimaryDeep = Color(red: 0.055, green: 0.2, blue: 0.251)
    static let skatePrimaryForeground = Color(red: 1, green: 1, blue: 1)
    static let skateInk = Color(red: 0.165, green: 0.176, blue: 0.18)
    static let skateInkMute = Color(red: 0.42, green: 0.447, blue: 0.459)
    static let skateInkFaint = Color(red: 0.608, green: 0.627, blue: 0.639)
    static let skateCanvas = Color(red: 1, green: 1, blue: 1)
    ...
    static let skateSurfaceTealDeep = Color(red: 0.055, green: 0.2, blue: 0.251)
    ...
    static let skateHairlineDark = Color(red: 0.165, green: 0.29, blue: 0.322)
