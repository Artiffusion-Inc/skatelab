...
class ExportViewModelTest {
    ...
    @Test
    fun export_success_setsExportPath() = testScope.runTest {
    ...
    @Test
    fun export_sessionNotFound_setsError() = testScope.runTest {
        val outputDir = createTempDir("export_test")
    ...
    @Test
    fun export_failure_setsError() = testScope.runTest {
        val outputDir = createTempDir("export_test")
        coEvery { sessionRepository.getSession("export-test") } returns stubSession
    ...
    @Test
    fun export_resetsIsExporting() = testScope.runTest {
        val outputDir = createTempDir("export_test")
        coEvery { sessionRepository.getSession("export-test") } returns stubSession
        coEvery { exportUseCase.invoke(stubSession, any()) } returns
