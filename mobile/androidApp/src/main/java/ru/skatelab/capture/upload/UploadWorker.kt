...
class UploadWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        ...
        return try {
            ...
            val session = skateLabClient.sessions.create(
                elementType = "axel", // default; can be refined later
                videoKey = videoKey,
    ...
    private suspend fun uploadPresigned(file: File, contentType: String): String {
        val presign = skateLabClient.uploads.presign(file.name, contentType)
        val response: io.ktor.client.statement.HttpResponse = skateLabClient.httpClient.put(presign.url) {
