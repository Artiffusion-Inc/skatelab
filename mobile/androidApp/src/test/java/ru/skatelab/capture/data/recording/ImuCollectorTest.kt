...
class ImuCollectorTest {
    ...
    private val reconnectEventsFlow =
        MutableSharedFlow<SensorId>(
    ...
    private fun sample(timestampNs: Long) =
        ImuSample(
    ...
    @Test
    fun start_opensWritersAndCollectsSamples() =
        testScope.runTest {
    ...
    @Test
    fun stop_closesWritersAndReturnsCounts() =
        testScope.runTest {
    ...
    @Test
    fun reconnectEvent_triggersGapInsertionOnNextSample() =
        testScope.runTest {
    ...
    @Test
    fun start_ignoresUnmappedSensorId() =
        testScope.runTest {
