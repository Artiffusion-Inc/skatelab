...
| **Крепление**            | ~150 ₽ *(липучка + EVA-прокладка, прототип)* |
| **Variable Cost**                   | ~3 030 ₽ *(BOM + крепление — прямые затраты на единицу)*                |
| **Налог УСН 15%**                   | ~2 325 ₽                                                                 |
| **Итого VC с налогом**              | **TBD** *(зависит от цены продажи)*                                     |
...
| **LTV / CAC**                       | TBD                                                                       |
| **Break-even (математический)**     | TBD *(зависит от цены продажи)*                                          |
| **Break-even (реалистичный)**       | TBD *(зависит от FC с зарплатами основателей)*                          |
