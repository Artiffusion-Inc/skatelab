 ...
 *   - clearTokens (src/lib/api-client.ts:37):
 *       `sb_auth=; path=/; max-age=0`
 *       → host-only deletion (matches login/register).
 *   - setTokens   (src/lib/api-client.ts:32) / silentRefresh (src/lib/api-client.ts:71):
 *       `sb_auth=1; ...` → host-only set.
 *
 * So:
...
const CLEAR_COOKIE = "sb_auth=; path=/; max-age=0" // api-client.ts:37 clearTokens()
const REFRESH_SET_COOKIE = "sb_auth=1; path=/; max-age=31536000; SameSite=Lax" // api-client.ts:32/:71
