...
export function AccuracySection() {
  ...
  const videoMetrics = [
    { key: "v1", value: t("accuracyVideoValue1"), desc: t("accuracyVideoDesc1") },
    { key: "v2", value: t("accuracyVideoValue2"), desc: t("accuracyVideoDesc2") },
    { key: "v3", value: t("accuracyVideoValue3"), desc: t("accuracyVideoDesc3") },
  ]

  const imuMetrics = [
    { key: "i1", value: t("accuracyImuValue1"), desc: t("accuracyImuDesc1") },
    { key: "i2", value: t("accuracyImuValue2"), desc: t("accuracyImuDesc2") },
    { key: "i3", value: t("accuracyImuValue3"), desc: t("accuracyImuDesc3") },
  ]
    ...
    >
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_1.4fr]">
        <div className="rounded-lg border border-hairline bg-background p-8">
          <p className="sh-caption text-ink-mute mb-6">{t("accuracyVideoLabel")}</p>
        ...
        <div className="rounded-lg border border-primary bg-canvas-soft p-8">
          <p className="sh-caption text-primary mb-6">{t("accuracyImuLabel")}</p>
          <ul className="space-y-6">
            {imuMetrics.map(m => (
              <li key={m.key} className="flex flex-col gap-1">
