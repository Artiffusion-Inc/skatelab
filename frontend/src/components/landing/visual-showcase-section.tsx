...
export function VisualShowcaseSection() {
  ...
  const visuals = [
    { key: "video", label: t("visualVideoLabel"), desc: t("visualVideoDesc") },
    { key: "dashboard", label: t("visualDashboardLabel"), desc: t("visualDashboardDesc") },
    { key: "3d", label: t("visual3dLabel"), desc: t("visual3dDesc") },
  ]
