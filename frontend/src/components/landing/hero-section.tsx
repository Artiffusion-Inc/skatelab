    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl px-6 py-16 sm:py-20 lg:py-24">
        <div className="max-w-2xl">
          ...
          <h1 className="hero-headline sh-display-xxl text-ink max-w-[65ch]">{t("headline")}</h1>
          ...
          <div className="hero-cta mt-10 flex flex-col items-start gap-4 sm:flex-row sm:items-center">
            ...
            <Button
              variant="outline"
              size="lg"
              className="min-h-[44px] h-14 px-8 text-base sh-button-cap border-hairline-dark"
              asChild
            >
