    ...
    <LegalLayout>
      ...
      <div className="space-y-6 sh-body-md text-ink-mute">
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody>
            ...
            <tr className="border-b border-hairline">
              ...
              <td className="py-2 pr-4">Необходимые</td>
              <td className="py-2 pr-4">
                PostHog feature flags — определяют функциональность приложения
              </td>
              <td className="py-2">13 месяцев</td>
            </tr>
            {/* Recordings */}
        ...
        <p>
          ...
          анонимизированный daily-salted hash (cookieless режим) — данные ограничены. Feature flags
          работают всегда (это функциональность, не отслеживание). Срок хранения аналитических
          данных — не более 13 месяцев.
        </p>
