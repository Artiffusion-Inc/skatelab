  ...
  return (
    <LegalLayout>
      ...
      <div className="space-y-6 sh-body-md text-ink-mute">
        ...
        <p>
          В настоящий момент мы не используем аналитические cookies. При внедрении (PostHog) они
          будут требовать вашего согласия и использовать анонимизированные идентификаторы. Срок
          хранения — не более 13 месяцев.
        </p>
