...
def generate_training_plan(
    subscores: list[SubScore], session_id: str | None = None, lang: str = "ru"
) -> TrainingPlan:
    ...
    Args:
        ...
        lang: Output language — "ru" (default, backward compatible) or "en".
            ...
            ``description_ru`` fields of each :class:`TrainingPlanItem`
            (the field names are kept for API-contract stability; the
            caller chooses the language of the content).
